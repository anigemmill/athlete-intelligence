              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col">
                  {athletes.map((athlete: any, i: number) => (
                    <TiltCard key={i} intensity={4} className="grid grid-cols-[2fr_1.5fr_1fr_1fr] items-center px-5 py-4 border-b border-[#DCE2EF] last:border-0 hover:bg-[#FCFAFA] cursor-pointer group transition-colors rounded-lg">
                      <div className="flex items-center gap-3">
